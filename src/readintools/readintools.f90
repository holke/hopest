...
TYPE(tString),POINTER :: Str         ! String to delete
!===================================================================================================================================
DO WHILE(ASSOCIATED(FirstString))
  Str=>FirstString%NextStr
...
DO WHILE(.NOT.Found)
  IF (.NOT.ASSOCIATED(Str1)) THEN
    IF (.NOT.PRESENT(Proposal)) THEN
      CALL abort(__STAMP__,  &
           'Inifile missing necessary keyword item : '//TRIM(TmpKey)//' - Code stopped!')
