...
void
p4est_connectivity_treevertex (p4est_topidx_t num_vertices,
...
void
p4est_get_mesh_info (p4est_t * p4est,
                     p4est_mesh_t * mesh,
                     int *global_num_quadrants, int *num_half_faces)
{
...
void
p4est_get_quadrants (p4est_t * p4est,
                     p4est_mesh_t * mesh,
                     ...
                     p4est_qcoord_t * quadcoords, int8_t * quadlevel)
{
...
void
p4est_save_all (char filename[], p4est_t * p4est)
{
