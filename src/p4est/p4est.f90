...
! LOCAL VARIABLES
!===================================================================================================================================
CALL InitP4ESTmatrices()
CALL p4_initvars()
p4estFile = GETSTR('p4estFile',TRIM(ProjectName)//'.p4est')

END SUBROUTINE InitP4EST

SUBROUTINE InitP4ESTmatrices()
!===================================================================================================================================
! 
!===================================================================================================================================
! MODULES
USE, INTRINSIC :: ISO_C_BINDING
USE MODH_P4EST_Vars,    ONLY: P4R,P4Q,P4P,H_MortarCase
!-----------------------------------------------------------------------------------------------------------------------------------
! INPUT VARIABLES
!-----------------------------------------------------------------------------------------------------------------------------------
! OUTPUT VARIABLES
...
! LOCAL VARIABLES
!===================================================================================================================================
P4R(0:5,0:5) = TRANSPOSE(RESHAPE((/ 0,1,1,0,0,1,&
                                    2,0,0,1,1,0,&
                                    2,0,0,1,1,0,&
                                    0,2,2,0,0,1,&
                                    2,0,0,2,2,0,&
                                    2,0,0,2,2,0/),(/6,6/)))
P4Q(0:2,0:3) = TRANSPOSE(RESHAPE((/ 1,2,5,6,&
                                    0,3,4,7,&
                                    0,4,3,7 /),(/4,3/)))
P4P(0:7,0:3) = TRANSPOSE(RESHAPE((/ 0,1,2,3,&
                                    0,2,1,3,&
                                    1,0,3,2,&
                                    1,3,0,2,&
                                    2,0,3,1,&
                                    ...
                                    3,1,2,0,&
                                    3,2,1,0 /),(/4,8/)))
!  first CGNS node and second CGNS node->Mortar Case [1:8]
H_MortarCase(1:4,1:4) =  TRANSPOSE(RESHAPE((/  0,1,0,2,&                         ! (1,2)->1, (1,4)->2
                                               3,0,4,0,&                         ! (2,1)->3, (2,3)->4
                                               0,5,0,6,&                         ! (3,2)->5, (3,4)->6
                                               7,0,8,0 /),(/4,4/)))              ! (4,1)->7, (4,3)->8

END SUBROUTINE InitP4ESTmatrices
