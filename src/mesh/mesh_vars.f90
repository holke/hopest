...
!-----------------------------------------------------------------------------------------------------------------------------------
INTEGER,PARAMETER :: EdgeToElemNode(1:2,1:12) = RESHAPE((/ 1, 2, 4, 3, 5, 6,8, 7,1, 4,2, 3,5, 8,6, 7,1, 5,2, 6,4, 8,3,7/),(/2,12/))
!INTEGER,PARAMETER              :: EdgeToElemNode(1:2,1:12) = (/ 1, 2,&  ! CGNS corner nodes mapped 
                                                                !4, 3,&  ! to p4est edges
                                                                !5, 6,&
                                                                !8, 7,&
                                                                !1, 4,&
